...
const cb = {
  ...
  ctas: { display:'flex', gap:20, alignItems:'center', flexWrap:'wrap' },
  ...
  phoneLine: { fontFamily:'inherit', fontSize:15, fontWeight:500, color:'rgba(255,255,255,0.7)', lineHeight:1.4 },
  phonePrefix: { color:'rgba(255,255,255,0.7)' },
  phoneLink: { color:'#fff', textDecoration:'none', borderBottom:'1px solid rgba(255,255,255,0.35)', paddingBottom:2, fontWeight:500, transition:'border-color 150ms ease-out, color 150ms ease-out' },
